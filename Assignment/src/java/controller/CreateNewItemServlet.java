...
public class CreateNewItemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean flag = ItemDao.createItem(Integer.parseInt(id), name, Integer.parseInt(price), Integer.parseInt(cid));
            if (flag) {
                request.setAttribute("Success", "Create a new item successfully!");
            } else {
